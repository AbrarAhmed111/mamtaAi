...
import { FaEye, FaEyeSlash, FaEnvelope, FaLock, FaUser, FaPhone, FaArrowLeft, FaBaby, FaCheck } from 'react-icons/fa';
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Join thousands of parents using MamtaAI
          </p>
        </div>
                ...
                <div className="mt-2 space-y-1">
                  {passwordRequirements.map((req, index) => (
                    <div key={index} className="flex items-center text-sm">
                      <FaCheck className={`h-4 w-4 mr-2 ${req.met ? 'text-green-500' : 'text-gray-400'}`} />
